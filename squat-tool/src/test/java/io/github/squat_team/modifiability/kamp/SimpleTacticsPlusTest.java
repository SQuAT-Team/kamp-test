...
public class SimpleTacticsPlusTest {
	...
	private void loadPCMModel() {
		// machinePath =
		// "/Users/santiagovidal/Documents/Programacion/kamp-test/squat-tool/src/test/resources/";
		// dirPath = machinePath + "io/github/squat_team/casestudies/SimpleTactics+/";
		// modelNames = new String[]{"stplus","stplus-0-Payment
		// System","stplus-1-Payment System"};
		machinePath = "/Users/santiagovidal/Downloads/";
		dirPath = machinePath + "stplus-final/";
		modelNames = new String[] { "stplus", "stplus-0-Payment System", "stplus-0-IExporter", "stplus-1-ITripDB",
				"stplus-2-IExternalPayment", "stplus-3-IEmployeePayment", "stplus-4-IBooking",
				"stplus-5-IBusiness Trip", "stplus-split-0-IExporter", "stplus-split-1-ITripDB",
				"stplus-split-2-IExternalPayment", "stplus-split-3-IEmployeePayment", "stplus-split-4-IBooking",
				"stplus-split-5-IBusiness Trip" };
	...
	public void testAnalysis() throws Exception {
		...
		for (int i = 0; i < modelNames.length; i++) {
			PCMArchitectureInstance model = loadSpecificModel(repositoryFile[i], repositoryFile[i],
			...
			java.lang.System.out
					.println("The number of affected components is: " + ((Float) response_alt1).floatValue());
		}
		/*
		 * PCMArchitectureInstance stplus_base =
		 * this.loadSimpleTacticsPlus("SimpleTactics+BASE"); PCMArchitectureInstance
		 * stplus_alt0 = this.loadSimpleTacticsPlusAlt0("SimpleTactics+ALT0");
		 * PCMArchitectureInstance stplus_alt1 =
		 * this.loadSimpleTacticsPlusAlt1("SimpleTactics+ALT1");
		 */
		//
		/*
		 * PCMScenarioResult scenarioResult_base = bot.analyze(stplus_base); String
		 * satisfaction_base = scenarioResult_base.isSatisfied() >= 0 ? "SATISFIED" :
		 * "NOT SATISFIED";
		 * java.lang.System.out.println("The scenario satisfaction with " +
		 * stplus_base.getName() + " is: " + satisfaction_base);
		 */
		// Assert.assertTrue(scenarioResult_base.isSatisfied() < 0);
		/*
		 * int AFFECTED_COMPONENTS = 6; Comparable response_base =
		 * scenarioResult_base.getResult().getResponse();
		 * java.lang.System.out.println("The number of affected components is: " +
		 * ((Float)response_base).floatValue());
		 */
		// Assert.assertEquals(((Float)response_base).floatValue(),
		// AFFECTED_COMPONENTS);
		//
		/*
		 * PCMScenarioResult scenarioResult_alt0 = bot.analyze(stplus_alt0); String
		 * satisfaction_alt0 = scenarioResult_alt0.isSatisfied() >= 0 ? "SATISFIED" :
		 * "NOT SATISFIED";
		 * java.lang.System.out.println("The scenario satisfaction with " +
		 * stplus_alt0.getName() + " is: " + satisfaction_alt0);
		 */
		 ...
		 * java.lang.System.out.println("The number of affected components is: " +
		 * ((Float)response_alt0).floatValue());
		 */
		// Assert.assertEquals(((Integer)response_alt0).intValue(),
		// AFFECTED_COMPONENTS);
		//
		/*
		 * PCMScenarioResult scenarioResult_alt1 = bot.analyze(stplus_alt1); String
		 * satisfaction_alt1 = scenarioResult_alt0.isSatisfied() >= 0 ? "SATISFIED" :
		 * "NOT SATISFIED";
		 * java.lang.System.out.println("The scenario satisfaction with " +
		 * stplus_alt1.getName() + " is: " + satisfaction_alt1);
		 */
		 ...
		 * java.lang.System.out.println("The number of affected components is: " +
		 * ((Float)response_alt1).floatValue());
		 */
		// Assert.assertEquals(((Integer)response_alt1).intValue(),
		// AFFECTED_COMPONENTS);
	}
	...
	private PCMScenario createModifiabilityScenario() {
		 ...
		 * expectedResult = new PCMResult(ResponseMeasureType.DECIMAL);
		 * expectedResult.setResponse(new Float(5));
		 * scenario.setExpectedResponse(expectedResult); ModifiabilityInstruction i1 =
		 * new ModifiabilityInstruction(); i1.operation = ModifiabilityOperation.MODIFY;
		 * i1.element = ModifiabilityElement.INTERFACE; i1.parameters.put("name",
		 * "IExternalPayment"); scenario.addChange(i1); ModifiabilityInstruction i2 =
		 * new ModifiabilityInstruction(); i2.operation = ModifiabilityOperation.MODIFY;
		 * i2.element = ModifiabilityElement.COMPONENT; i2.parameters.put("name",
		 * "BusinessTripMgmt"); scenario.addChange(i2);
		 */
		 ...
		 * i1.element = ModifiabilityElement.INTERFACE; i1.parameters.put("name",
		 * "IExternalPayment"); scenario.addChange(i1); ModifiabilityInstruction i2 =
		 * new ModifiabilityInstruction(); i2.operation = ModifiabilityOperation.CREATE;
		 * i2.element = ModifiabilityElement.OPERATION; i2.parameters.put("iname",
		 * "IExternalPayment"); i2.parameters.put("oname", "specialPay");
		 * scenario.addChange(i2); ModifiabilityInstruction i3 = new
		 ...
		 * "BusinessTripMgmt"); scenario.addChange(i3);
		 */
		...
		/*
		 * SCENARIO 2: this scenarios doesn't work because Kamp doesn't propagate
		 * changes to components when an operation is added to an interface
		 * ModifiabilityPCMScenario scenario = new
		 * ModifiabilityPCMScenario(OptimizationType.MINIMIZATION); PCMResult
		 * expectedResult = new PCMResult(ResponseMeasureType.DECIMAL);
		 * expectedResult.setResponse(new Float(5));
		 * scenario.setExpectedResponse(expectedResult); ModifiabilityInstruction i1 =
		 * new ModifiabilityInstruction(); i1.operation = ModifiabilityOperation.CREATE;
		 * i1.element = ModifiabilityElement.OPERATION; i1.parameters.put("iname",
		 * "ITripDB"); i1.parameters.put("oname", "executeReport");
		 * scenario.addChange(i1);
		 * 
		 ...
		 * "getLastTrips"); scenario.addChange(i3);
		 * 
		 * 
		 * ModifiabilityInstruction i4 = new ModifiabilityInstruction(); i4.operation =
		 * ModifiabilityOperation.CREATE; i4.element = ModifiabilityElement.COMPONENT;
		 * i4.parameters.put("name", "Insights"); scenario.addChange(i4);
		 * 
		 * ModifiabilityInstruction i5 = new ModifiabilityInstruction(); i5.operation =
		 * ModifiabilityOperation.CREATE; i5.element =
		 * ModifiabilityElement.PROVIDEDROLE; i5.parameters.put("cname", "Insights");
		 * i5.parameters.put("iname", "Analytics"); scenario.addChange(i5);
		 * 
	 ...
	 * SQuATHelper.loadResourceEnvironmentModel(resourceEnvironmentFile[0]); System
	 * system = SQuATHelper.loadSystemModel(baseSystemFile[0]); Allocation
	 * allocation = SQuATHelper.loadAllocationModel(baseAllocationFile[0]);
	 * UsageModel usageModel = SQuATHelper.loadUsageModel(baseUsageFile[0]);
	 * PCMArchitectureInstance instance = new PCMArchitectureInstance(name,
	 * repository, system, allocation, resourceEnvironment, usageModel);
	 */
	/*
	 * java.lang.System.out.println("SimpleTacticsPlus"); for(RepositoryComponent
	 * component:repository.getComponents__Repository()){ KAMPPCMBot bot = new
	 * KAMPPCMBot(null);
	 * java.lang.System.out.println(component.getEntityName()+" "+bot.
	 * getComplexityForComponent((BasicComponent) component)); }
	 */
	 ...
	 * ResourceEnvironment resourceEnvironment =
	 * SQuATHelper.loadResourceEnvironmentModel(resourceEnvironmentFile[1]); System
	 * system = SQuATHelper.loadSystemModel(baseSystemFile[1]); Allocation
	 * allocation = SQuATHelper.loadAllocationModel(baseAllocationFile[1]);
	 ...
	 * ResourceEnvironment resourceEnvironment =
	 * SQuATHelper.loadResourceEnvironmentModel(resourceEnvironmentFile[2]); System
	 * system = SQuATHelper.loadSystemModel(baseSystemFile[2]); Allocation
	 * allocation = SQuATHelper.loadAllocationModel(baseAllocationFile[2]);
