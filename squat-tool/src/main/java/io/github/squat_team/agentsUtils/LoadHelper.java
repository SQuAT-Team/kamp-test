...
public class LoadHelper {
	...
	private PCMArchitectureInstance loadSpecificModel(ArchitecturalVersion architecturalVersion) {
		Repository repository = SQuATHelper.loadRepositoryModel(architecturalVersion.getPath()+"/"+architecturalVersion.getRepositoryFilename());
		ResourceEnvironment resourceEnvironment = SQuATHelper.loadResourceEnvironmentModel(architecturalVersion.getPath()+"/"+architecturalVersion.getResourceEnvironmentFilename());
		System system = SQuATHelper.loadSystemModel(architecturalVersion.getPath()+"/"+architecturalVersion.getSystemFilename());
		Allocation allocation = SQuATHelper.loadAllocationModel(architecturalVersion.getPath()+"/"+architecturalVersion.getAllocationFilename());
		UsageModel usageModel = SQuATHelper.loadUsageModel(architecturalVersion.getPath()+"/"+architecturalVersion.getUsageFilename());
		PCMArchitectureInstance instance = new PCMArchitectureInstance(architecturalVersion.getFileName(), repository, system, allocation,
	...
	public List<SillyBot> loadBotsWithInformation() {
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 111.0f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-118"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-275"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-351"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-355"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-382"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-389"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-390"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-406"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-425"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-428"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-220"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-290"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-327"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-377"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-406"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-423"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-439"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-446"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-447"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-454"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-197"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-232"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-233"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-235"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-276"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-277"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-33"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-355"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-362"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-368"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-12"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-13"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-176"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-224"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-281"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-318"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-356"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-402"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-438"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-483"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-100"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-145"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-232"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-300"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-326"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-353"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-400"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-474"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-488"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-86"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-319"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-321"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-323"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-356"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-392"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-397"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-426"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-427"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-433"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-62"));
		...
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-143"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-191"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-268"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-307"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-314"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-352"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-354"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-355"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-55"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-7"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-137"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-142"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-171"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-189"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-209"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-238"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-275"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-281"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-285"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-414"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-192"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-203"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-275"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-279"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-360"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-364"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-403"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-439"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-450"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*3,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-492"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-250"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-321"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-33"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-359"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-360"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-369"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-370"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-456"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-499"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-501"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-226"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-325"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-401"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-415"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-452"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-456"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-462"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-505"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-506"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-508"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-119"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-242"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-278"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-344"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-373"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-407"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-408"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-439"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-447"));
		m1Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 119.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-482"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 171.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 171.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 171.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.0f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 171.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 171.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 251.0f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*7,*/ 291.5f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 171.0f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*7,*/ 291.5f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*7,*/ 291.5f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*7,*/ 291.5f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*7,*/ 291.5f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExporter)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*4,*/ 110.5f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBooking)"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*5,*/ 190.5f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-118"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-275"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-351"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-355"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-382"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-389"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-390"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-406"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-425"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-428"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-220"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-290"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-327"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-377"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-406"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-423"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-439"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-446"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-447"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-454"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-197"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-232"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-233"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-235"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-276"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-277"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-33"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-355"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-362"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-368"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-12"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-13"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-176"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-224"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-281"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-318"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-356"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-402"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-438"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-483"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-100"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-145"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-232"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-300"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-326"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-353"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-400"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-474"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-488"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-86"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-319"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-321"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-323"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-356"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-392"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-397"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-426"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-427"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-433"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-62"));
		...
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-143"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-191"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-268"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-307"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-314"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-352"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-354"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-355"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-55"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-7"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-137"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-142"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-171"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-189"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-209"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-238"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-275"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-281"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-285"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*6,*/ 231.5f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-414"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-192"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-203"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-275"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-279"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-360"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-364"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-403"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-439"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-450"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-492"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-250"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-321"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-33"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-359"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-360"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-369"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-370"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-456"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-499"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-501"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-226"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-325"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-401"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-415"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-452"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-456"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-462"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-505"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-506"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-508"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-119"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-242"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-278"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-344"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-373"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-407"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-408"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-439"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-447"));
		m2Bot.insertInOrder(new ModifiabilityProposal(/*8,*/ 352.0f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-482"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(152.77259999999998f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(112.94460000000001f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(119.5708f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(112.6332f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(132.47140000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(111.7639f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(11.432549999999999f, "stplus-ps1-258-mod-wrapper(IEmployeePayment)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(10.93995f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.339970000000001f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.3581f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.432549999999999f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.3576f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.99521f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(10.60364f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.525360000000001f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.65164f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(10.56804f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.651209999999999f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.55792f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(12.44062f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.10613f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.10167f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.4722f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.55829f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.11522f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(14.38377f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.128359999999999f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(16.72106f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.30196f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.91916f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.0997f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(13.41306f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.82484f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.13226f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.37513f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.131920000000001f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.79026f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(14.858799999999999f, "stplus-ps1-404-mod-wrapper(IEmployeePayment)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(14.279599999999999f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.92298f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(18.77187f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.858799999999999f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(18.76987f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.92561f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(8.468589999999999f, "stplus-ps1-436-mod-wrapper(IEmployeePayment)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(8.492619999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(9.56327f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(9.05711f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(8.468589999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(9.05667f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(9.557970000000001f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(13.04698f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(15.27455f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.2148f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.95466f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.21432f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.72516f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(10.870629999999998f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.384599999999999f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.27804f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.34901f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.277470000000001f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.38684f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(11.79327f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.17156f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.65882f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(11.74493f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.49846f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.93f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(14.6781f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(15.27123f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(22.63973f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(15.41826f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(17.878999999999998f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(22.28275f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(21.613599999999998f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(21.21669f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(20.92282f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(20.63689f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(39.669200000000004f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(21.48976f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(29.411260000000002f, "stplus-ps2-325-mod-wrapper(IEmployeePayment)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(29.002039999999997f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(27.29576f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(42.5131f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(29.411260000000002f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(42.5113f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(28.966f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(27.272199999999998f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(26.4703f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(26.73758f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(26.17676f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(26.73724f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(26.44102f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(21.623089999999998f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(22.13669f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(22.90915f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(21.77399f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(23.031850000000002f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(22.05999f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(21.504649999999998f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(21.84139f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(21.20684f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(40.1109f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(22.730919999999998f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(13.599920000000001f, "stplus-ps2-416-mod-wrapper(IExternalPayment)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(12.539290000000001f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.706700000000001f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(13.599920000000001f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.46173f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(12.475200000000001f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(14.056719999999999f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(29.4814f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(28.5854f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(31.0958f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(28.7494f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(31.095399999999998f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(34.3263f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(19.110860000000002f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(19.60118f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(24.37365f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(19.68762f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(22.90472f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(28.797f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(20.668599999999998f, "stplus-ps2-480-mod-wrapper(IEmployeePayment)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(20.71125f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p1Bot.insertInOrder(new PerformanceProposal(20.15777f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p1Bot.insertInOrder(new PerformanceProposal(25.29176f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(20.668599999999998f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p1Bot.insertInOrder(new PerformanceProposal(25.29034f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p1Bot.insertInOrder(new PerformanceProposal(20.173589999999997f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(15.613790000000002f, "stplus-mod-wrapper(IExternalPayment)-ps1-350"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(11.033100000000001f, "stplus-mod-wrapper(IExternalPayment)-ps1-464"));
		p1Bot.insertInOrder(new PerformanceProposal(9.41847f, "stplus-mod-wrapper(IEmployeePayment)-ps1-109"));
		p1Bot.insertInOrder(new PerformanceProposal(8.638819999999999f, "stplus-mod-wrapper(IEmployeePayment)-ps1-133"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(9.095369999999999f, "stplus-mod-wrapper(IEmployeePayment)-ps1-330"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(8.448640000000001f, "stplus-mod-wrapper(IEmployeePayment)-ps1-447"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(10.55321f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-118"));
		p1Bot.insertInOrder(new PerformanceProposal(10.89984f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-275"));
		p1Bot.insertInOrder(new PerformanceProposal(11.575510000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-351"));
		p1Bot.insertInOrder(new PerformanceProposal(10.89984f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-355"));
		p1Bot.insertInOrder(new PerformanceProposal(10.95584f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-382"));
		p1Bot.insertInOrder(new PerformanceProposal(12.6481f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-389"));
		p1Bot.insertInOrder(new PerformanceProposal(9.01331f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-390"));
		p1Bot.insertInOrder(new PerformanceProposal(12.41395f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-406"));
		p1Bot.insertInOrder(new PerformanceProposal(10.54378f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-425"));
		p1Bot.insertInOrder(new PerformanceProposal(10.924479999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-428"));
		p1Bot.insertInOrder(new PerformanceProposal(11.99257f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-220"));
		p1Bot.insertInOrder(new PerformanceProposal(14.564689999999999f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-290"));
		p1Bot.insertInOrder(new PerformanceProposal(11.38384f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-327"));
		p1Bot.insertInOrder(new PerformanceProposal(11.514140000000001f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-377"));
		p1Bot.insertInOrder(new PerformanceProposal(12.10687f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-406"));
		p1Bot.insertInOrder(new PerformanceProposal(16.73878f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-423"));
		p1Bot.insertInOrder(new PerformanceProposal(8.94556f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-439"));
		p1Bot.insertInOrder(new PerformanceProposal(13.581f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-446"));
		p1Bot.insertInOrder(new PerformanceProposal(11.785350000000001f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-447"));
		p1Bot.insertInOrder(new PerformanceProposal(15.923829999999999f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-454"));
		p1Bot.insertInOrder(new PerformanceProposal(13.6663f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-197"));
		p1Bot.insertInOrder(new PerformanceProposal(9.45898f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-232"));
		p1Bot.insertInOrder(new PerformanceProposal(10.60521f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-233"));
		p1Bot.insertInOrder(new PerformanceProposal(11.07619f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-235"));
		p1Bot.insertInOrder(new PerformanceProposal(11.07619f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-276"));
		p1Bot.insertInOrder(new PerformanceProposal(9.45898f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-277"));
		p1Bot.insertInOrder(new PerformanceProposal(9.45898f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-33"));
		p1Bot.insertInOrder(new PerformanceProposal(11.07619f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-355"));
		p1Bot.insertInOrder(new PerformanceProposal(13.68803f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-362"));
		p1Bot.insertInOrder(new PerformanceProposal(10.24548f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-368"));
		p1Bot.insertInOrder(new PerformanceProposal(11.83248f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-12"));
		p1Bot.insertInOrder(new PerformanceProposal(11.869720000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-13"));
		p1Bot.insertInOrder(new PerformanceProposal(12.59074f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-176"));
		p1Bot.insertInOrder(new PerformanceProposal(9.81963f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-224"));
		p1Bot.insertInOrder(new PerformanceProposal(12.85938f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-281"));
		p1Bot.insertInOrder(new PerformanceProposal(13.27472f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-318"));
		p1Bot.insertInOrder(new PerformanceProposal(12.569939999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-356"));
		p1Bot.insertInOrder(new PerformanceProposal(12.15383f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-402"));
		p1Bot.insertInOrder(new PerformanceProposal(9.06743f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-438"));
		p1Bot.insertInOrder(new PerformanceProposal(13.27856f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-483"));
		p1Bot.insertInOrder(new PerformanceProposal(11.52449f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-100"));
		p1Bot.insertInOrder(new PerformanceProposal(16.99513f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-145"));
		p1Bot.insertInOrder(new PerformanceProposal(12.05522f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-232"));
		p1Bot.insertInOrder(new PerformanceProposal(12.18489f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-300"));
		p1Bot.insertInOrder(new PerformanceProposal(18.4973f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-326"));
		p1Bot.insertInOrder(new PerformanceProposal(9.548680000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-353"));
		p1Bot.insertInOrder(new PerformanceProposal(17.16592f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-400"));
		p1Bot.insertInOrder(new PerformanceProposal(17.69796f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-474"));
		p1Bot.insertInOrder(new PerformanceProposal(12.23377f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-488"));
		p1Bot.insertInOrder(new PerformanceProposal(16.99513f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-86"));
		p1Bot.insertInOrder(new PerformanceProposal(11.93386f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-319"));
		p1Bot.insertInOrder(new PerformanceProposal(12.003530000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-321"));
		p1Bot.insertInOrder(new PerformanceProposal(13.041530000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-323"));
		p1Bot.insertInOrder(new PerformanceProposal(10.82422f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-356"));
		p1Bot.insertInOrder(new PerformanceProposal(12.916f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-392"));
		p1Bot.insertInOrder(new PerformanceProposal(10.8733f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-397"));
		p1Bot.insertInOrder(new PerformanceProposal(12.798860000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-426"));
		p1Bot.insertInOrder(new PerformanceProposal(11.69247f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-427"));
		p1Bot.insertInOrder(new PerformanceProposal(12.632090000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-433"));
		p1Bot.insertInOrder(new PerformanceProposal(14.583750000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-62"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(18.612299999999998f, "stplus-mod-wrapper(IExternalPayment)-ps2-445"));
		p1Bot.insertInOrder(new PerformanceProposal(11.603349999999999f, "stplus-mod-wrapper(IExternalPayment)-ps2-449"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(15.425529999999998f, "stplus-mod-wrapper(IEmployeePayment)-ps2-441"));
		...
		p1Bot.insertInOrder(new PerformanceProposal(13.63445f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-143"));
		p1Bot.insertInOrder(new PerformanceProposal(23.10754f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-191"));
		p1Bot.insertInOrder(new PerformanceProposal(22.945610000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-268"));
		p1Bot.insertInOrder(new PerformanceProposal(11.8173f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-307"));
		p1Bot.insertInOrder(new PerformanceProposal(21.74946f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-314"));
		p1Bot.insertInOrder(new PerformanceProposal(13.63445f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-352"));
		p1Bot.insertInOrder(new PerformanceProposal(13.485199999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-354"));
		p1Bot.insertInOrder(new PerformanceProposal(11.8173f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-355"));
		p1Bot.insertInOrder(new PerformanceProposal(18.58637f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-55"));
		p1Bot.insertInOrder(new PerformanceProposal(11.8173f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-7"));
		p1Bot.insertInOrder(new PerformanceProposal(14.355039999999999f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-137"));
		p1Bot.insertInOrder(new PerformanceProposal(17.69748f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-142"));
		p1Bot.insertInOrder(new PerformanceProposal(30.74481f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-171"));
		p1Bot.insertInOrder(new PerformanceProposal(15.45364f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-189"));
		p1Bot.insertInOrder(new PerformanceProposal(16.93228f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-209"));
		p1Bot.insertInOrder(new PerformanceProposal(20.4381f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-238"));
		p1Bot.insertInOrder(new PerformanceProposal(25.03268f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-275"));
		p1Bot.insertInOrder(new PerformanceProposal(31.998109999999997f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-281"));
		p1Bot.insertInOrder(new PerformanceProposal(18.38324f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-285"));
		p1Bot.insertInOrder(new PerformanceProposal(30.83079f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-414"));
		p1Bot.insertInOrder(new PerformanceProposal(9.339870000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-192"));
		p1Bot.insertInOrder(new PerformanceProposal(13.24279f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-203"));
		p1Bot.insertInOrder(new PerformanceProposal(17.38232f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-275"));
		p1Bot.insertInOrder(new PerformanceProposal(14.62181f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-279"));
		p1Bot.insertInOrder(new PerformanceProposal(17.47016f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-360"));
		p1Bot.insertInOrder(new PerformanceProposal(14.12246f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-364"));
		p1Bot.insertInOrder(new PerformanceProposal(10.32142f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-403"));
		p1Bot.insertInOrder(new PerformanceProposal(8.33966f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-439"));
		p1Bot.insertInOrder(new PerformanceProposal(18.67914f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-450"));
		p1Bot.insertInOrder(new PerformanceProposal(8.422609999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-492"));
		p1Bot.insertInOrder(new PerformanceProposal(14.597290000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-250"));
		p1Bot.insertInOrder(new PerformanceProposal(11.92469f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-321"));
		p1Bot.insertInOrder(new PerformanceProposal(11.336359999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-33"));
		p1Bot.insertInOrder(new PerformanceProposal(11.72219f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-359"));
		p1Bot.insertInOrder(new PerformanceProposal(11.82668f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-360"));
		p1Bot.insertInOrder(new PerformanceProposal(11.45097f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-369"));
		p1Bot.insertInOrder(new PerformanceProposal(11.65258f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-370"));
		p1Bot.insertInOrder(new PerformanceProposal(11.72219f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-456"));
		p1Bot.insertInOrder(new PerformanceProposal(11.82894f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-499"));
		p1Bot.insertInOrder(new PerformanceProposal(10.92929f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-501"));
		p1Bot.insertInOrder(new PerformanceProposal(16.95612f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-226"));
		p1Bot.insertInOrder(new PerformanceProposal(22.38673f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-325"));
		p1Bot.insertInOrder(new PerformanceProposal(22.36142f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-401"));
		p1Bot.insertInOrder(new PerformanceProposal(21.08694f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-415"));
		p1Bot.insertInOrder(new PerformanceProposal(21.23776f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-452"));
		p1Bot.insertInOrder(new PerformanceProposal(19.33157f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-456"));
		p1Bot.insertInOrder(new PerformanceProposal(23.11579f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-462"));
		p1Bot.insertInOrder(new PerformanceProposal(21.07343f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-505"));
		p1Bot.insertInOrder(new PerformanceProposal(22.36152f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-506"));
		p1Bot.insertInOrder(new PerformanceProposal(25.8517f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-508"));
		p1Bot.insertInOrder(new PerformanceProposal(27.011720000000004f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-119"));
		p1Bot.insertInOrder(new PerformanceProposal(24.317149999999998f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-242"));
		p1Bot.insertInOrder(new PerformanceProposal(17.993949999999998f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-278"));
		p1Bot.insertInOrder(new PerformanceProposal(26.8183f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-344"));
		p1Bot.insertInOrder(new PerformanceProposal(25.25987f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-373"));
		p1Bot.insertInOrder(new PerformanceProposal(26.8183f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-407"));
		p1Bot.insertInOrder(new PerformanceProposal(26.90352f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-408"));
		p1Bot.insertInOrder(new PerformanceProposal(21.89577f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-439"));
		p1Bot.insertInOrder(new PerformanceProposal(25.367890000000003f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-447"));
		p1Bot.insertInOrder(new PerformanceProposal(10.92604f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-482"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(115.82230000000001f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(78.7857f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(148.847f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(82.4342f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(74.0173f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(17.41649f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(19.987569999999998f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(19.34795f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(17.37807f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(19.34726f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(17.97024f, "stplus-ps1-258-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-281-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(31.5006f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(47.1184f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(30.4747f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(29.9416f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(30.8239f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(47.1098f, "stplus-ps1-338-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(18.138550000000002f, "stplus-ps1-340-mod-wrapper(IEmployeePayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(18.29758f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(21.8758f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(20.00966f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(18.138550000000002f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(19.97666f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(21.89328f, "stplus-ps1-340-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-397-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(31.572599999999998f, "stplus-ps1-404-mod-wrapper(IEmployeePayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(32.7703f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(48.4423f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(33.9226f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(31.572599999999998f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(33.9213f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(48.4371f, "stplus-ps1-404-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-436-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-444-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(22.95597f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(29.20285f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(24.4602f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(22.50902f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(24.459600000000002f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(29.20745f, "stplus-ps1-494-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(107.4466f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(90.0727f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(89.37719999999999f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(91.12819999999999f, "stplus-ps1-64-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(27.3495f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(35.370000000000005f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(31.1693f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(26.9658f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(28.8855f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(31.6697f, "stplus-ps2-209-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(26.680799999999998f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(34.913799999999995f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(30.5328f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(26.6729f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(33.806200000000004f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(26.6179f, "stplus-ps2-22-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(33.092510000000004f, "stplus-ps2-325-mod-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(26.724330000000002f, "stplus-ps2-325-mod-wrapper(IEmployeePayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(26.663130000000002f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(28.56223f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(33.092510000000004f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(26.724330000000002f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(33.09066f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.10814f, "stplus-ps2-325-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(27.119369999999996f, "stplus-ps2-330-mod-wrapper(IEmployeePayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(28.1041f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(29.896f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.65328f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.119369999999996f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.653f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(29.8716f, "stplus-ps2-330-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(26.9436f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(31.8175f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.393f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(26.4363f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.468f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-ps2-358-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(23.27813f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(25.2026f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(23.04414f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(22.53669f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(30.4235f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(23.8112f, "stplus-ps2-366-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(17.827939999999998f, "stplus-ps2-416-mod-wrapper(IExternalPayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(16.98077f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(20.74776f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(17.827939999999998f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(16.83071f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(18.914369999999998f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(18.26914f, "stplus-ps2-416-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(28.722299999999997f, "stplus-ps2-476-mod-wrapper(IExternalPayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(27.95384f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(28.2396f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(28.722299999999997f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.23682f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(28.721899999999998f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(30.6774f, "stplus-ps2-476-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(29.962200000000003f, "stplus-ps2-479-mod-wrapper(IExternalPayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(27.0407f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(31.6378f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(29.962200000000003f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(26.8958f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(28.9174f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(32.2499f, "stplus-ps2-479-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(24.192079999999997f, "stplus-ps2-480-mod-wrapper(IEmployeePayment)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(24.31005f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExporter)"));
		p2Bot.insertInOrder(new PerformanceProposal(31.4533f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(ITripDB)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.1398f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IExternalPayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(24.192079999999997f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IEmployeePayment)"));
		p2Bot.insertInOrder(new PerformanceProposal(27.1388f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBooking)"));
		p2Bot.insertInOrder(new PerformanceProposal(31.4772f, "stplus-ps2-480-mod-split(PaymentSystem)-wrapper(IBusinessTrip)"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(111.78269999999999f, "stplus-mod-wrapper(IExternalPayment)-ps1-195"));
		p2Bot.insertInOrder(new PerformanceProposal(22.81521f, "stplus-mod-wrapper(IExternalPayment)-ps1-247"));
		p2Bot.insertInOrder(new PerformanceProposal(111.78269999999999f, "stplus-mod-wrapper(IExternalPayment)-ps1-263"));
		p2Bot.insertInOrder(new PerformanceProposal(127.65870000000001f, "stplus-mod-wrapper(IExternalPayment)-ps1-333"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(28.883899999999997f, "stplus-mod-wrapper(IEmployeePayment)-ps1-417"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(21.945320000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-118"));
		p2Bot.insertInOrder(new PerformanceProposal(38.7785f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-275"));
		p2Bot.insertInOrder(new PerformanceProposal(23.42909f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-351"));
		p2Bot.insertInOrder(new PerformanceProposal(38.7785f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-355"));
		p2Bot.insertInOrder(new PerformanceProposal(23.14489f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-382"));
		p2Bot.insertInOrder(new PerformanceProposal(24.387050000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-389"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-390"));
		p2Bot.insertInOrder(new PerformanceProposal(34.0922f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-406"));
		p2Bot.insertInOrder(new PerformanceProposal(26.9446f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-425"));
		p2Bot.insertInOrder(new PerformanceProposal(27.2395f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps1-428"));
		p2Bot.insertInOrder(new PerformanceProposal(41.4988f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-220"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-290"));
		p2Bot.insertInOrder(new PerformanceProposal(41.09465f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-327"));
		p2Bot.insertInOrder(new PerformanceProposal(41.22681f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-377"));
		p2Bot.insertInOrder(new PerformanceProposal(41.5635f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-406"));
		p2Bot.insertInOrder(new PerformanceProposal(101.8545f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-423"));
		p2Bot.insertInOrder(new PerformanceProposal(22.372300000000003f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-439"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-446"));
		p2Bot.insertInOrder(new PerformanceProposal(41.4456f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-447"));
		p2Bot.insertInOrder(new PerformanceProposal(44.4581f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps1-454"));
		p2Bot.insertInOrder(new PerformanceProposal(22.32345f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-197"));
		p2Bot.insertInOrder(new PerformanceProposal(225.6522f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-232"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-233"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-235"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-276"));
		p2Bot.insertInOrder(new PerformanceProposal(225.6522f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-277"));
		p2Bot.insertInOrder(new PerformanceProposal(225.6522f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-33"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-355"));
		p2Bot.insertInOrder(new PerformanceProposal(22.35012f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-362"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps1-368"));
		p2Bot.insertInOrder(new PerformanceProposal(97.78909999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-12"));
		p2Bot.insertInOrder(new PerformanceProposal(22.792949999999998f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-13"));
		p2Bot.insertInOrder(new PerformanceProposal(19.30361f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-176"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-224"));
		p2Bot.insertInOrder(new PerformanceProposal(19.549709999999997f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-281"));
		p2Bot.insertInOrder(new PerformanceProposal(19.72704f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-318"));
		p2Bot.insertInOrder(new PerformanceProposal(19.27683f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-356"));
		p2Bot.insertInOrder(new PerformanceProposal(21.18271f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-402"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-438"));
		p2Bot.insertInOrder(new PerformanceProposal(19.73084f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps1-483"));
		p2Bot.insertInOrder(new PerformanceProposal(34.9658f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-100"));
		p2Bot.insertInOrder(new PerformanceProposal(117.64510000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-145"));
		p2Bot.insertInOrder(new PerformanceProposal(75.4641f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-232"));
		p2Bot.insertInOrder(new PerformanceProposal(28.88559f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-300"));
		p2Bot.insertInOrder(new PerformanceProposal(35.153f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-326"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-353"));
		p2Bot.insertInOrder(new PerformanceProposal(79.4713f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-400"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-474"));
		p2Bot.insertInOrder(new PerformanceProposal(23.85635f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-488"));
		p2Bot.insertInOrder(new PerformanceProposal(117.64510000000001f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps1-86"));
		p2Bot.insertInOrder(new PerformanceProposal(46.3283f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-319"));
		p2Bot.insertInOrder(new PerformanceProposal(46.3343f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-321"));
		p2Bot.insertInOrder(new PerformanceProposal(40.141999999999996f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-323"));
		p2Bot.insertInOrder(new PerformanceProposal(38.4923f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-356"));
		p2Bot.insertInOrder(new PerformanceProposal(47.1008f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-392"));
		p2Bot.insertInOrder(new PerformanceProposal(38.539f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-397"));
		p2Bot.insertInOrder(new PerformanceProposal(47.0098f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-426"));
		p2Bot.insertInOrder(new PerformanceProposal(999999999f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-427"));
		p2Bot.insertInOrder(new PerformanceProposal(46.8977f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-433"));
		p2Bot.insertInOrder(new PerformanceProposal(41.13f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps1-62"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(18.066119999999998f, "stplus-mod-wrapper(IExternalPayment)-ps2-145"));
		p2Bot.insertInOrder(new PerformanceProposal(21.32157f, "stplus-mod-wrapper(IExternalPayment)-ps2-147"));
		p2Bot.insertInOrder(new PerformanceProposal(20.506819999999998f, "stplus-mod-wrapper(IExternalPayment)-ps2-270"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(20.941789999999997f, "stplus-mod-wrapper(IExternalPayment)-ps2-449"));
		p2Bot.insertInOrder(new PerformanceProposal(19.967129999999997f, "stplus-mod-wrapper(IExternalPayment)-ps2-453"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(18.475929999999998f, "stplus-mod-wrapper(IEmployeePayment)-ps2-361"));
		...
		p2Bot.insertInOrder(new PerformanceProposal(23.244500000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-143"));
		p2Bot.insertInOrder(new PerformanceProposal(25.32114f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-191"));
		p2Bot.insertInOrder(new PerformanceProposal(22.69615f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-268"));
		p2Bot.insertInOrder(new PerformanceProposal(22.1229f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-307"));
		p2Bot.insertInOrder(new PerformanceProposal(23.17691f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-314"));
		p2Bot.insertInOrder(new PerformanceProposal(23.244500000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-352"));
		p2Bot.insertInOrder(new PerformanceProposal(22.82142f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-354"));
		p2Bot.insertInOrder(new PerformanceProposal(22.1229f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-355"));
		p2Bot.insertInOrder(new PerformanceProposal(25.055799999999998f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-55"));
		p2Bot.insertInOrder(new PerformanceProposal(22.1229f, "stplus-mod-split(PaymentSystem)-wrapper(IExporter)-ps2-7"));
		p2Bot.insertInOrder(new PerformanceProposal(18.8551f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-137"));
		p2Bot.insertInOrder(new PerformanceProposal(21.95852f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-142"));
		p2Bot.insertInOrder(new PerformanceProposal(30.25407f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-171"));
		p2Bot.insertInOrder(new PerformanceProposal(19.60371f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-189"));
		p2Bot.insertInOrder(new PerformanceProposal(26.7557f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-209"));
		p2Bot.insertInOrder(new PerformanceProposal(20.05168f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-238"));
		p2Bot.insertInOrder(new PerformanceProposal(25.74126f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-275"));
		p2Bot.insertInOrder(new PerformanceProposal(31.11766f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-281"));
		p2Bot.insertInOrder(new PerformanceProposal(28.0131f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-285"));
		p2Bot.insertInOrder(new PerformanceProposal(31.1847f, "stplus-mod-split(PaymentSystem)-wrapper(ITripDB)-ps2-414"));
		p2Bot.insertInOrder(new PerformanceProposal(20.67632f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-192"));
		p2Bot.insertInOrder(new PerformanceProposal(22.45086f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-203"));
		p2Bot.insertInOrder(new PerformanceProposal(22.4233f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-275"));
		p2Bot.insertInOrder(new PerformanceProposal(20.013109999999998f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-279"));
		p2Bot.insertInOrder(new PerformanceProposal(21.9542f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-360"));
		p2Bot.insertInOrder(new PerformanceProposal(23.8709f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-364"));
		p2Bot.insertInOrder(new PerformanceProposal(21.55081f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-403"));
		p2Bot.insertInOrder(new PerformanceProposal(23.67698f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-439"));
		p2Bot.insertInOrder(new PerformanceProposal(19.46049f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-450"));
		p2Bot.insertInOrder(new PerformanceProposal(23.78969f, "stplus-mod-split(PaymentSystem)-wrapper(IExternalPayment)-ps2-492"));
		p2Bot.insertInOrder(new PerformanceProposal(17.555030000000002f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-250"));
		p2Bot.insertInOrder(new PerformanceProposal(18.10486f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-321"));
		p2Bot.insertInOrder(new PerformanceProposal(17.77739f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-33"));
		p2Bot.insertInOrder(new PerformanceProposal(17.962629999999997f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-359"));
		p2Bot.insertInOrder(new PerformanceProposal(18.05766f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-360"));
		p2Bot.insertInOrder(new PerformanceProposal(17.7723f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-369"));
		p2Bot.insertInOrder(new PerformanceProposal(17.90887f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-370"));
		p2Bot.insertInOrder(new PerformanceProposal(17.962629999999997f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-456"));
		p2Bot.insertInOrder(new PerformanceProposal(17.97129f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-499"));
		p2Bot.insertInOrder(new PerformanceProposal(17.41653f, "stplus-mod-split(PaymentSystem)-wrapper(IEmployeePayment)-ps2-501"));
		p2Bot.insertInOrder(new PerformanceProposal(24.289299999999997f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-226"));
		p2Bot.insertInOrder(new PerformanceProposal(25.9407f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-325"));
		p2Bot.insertInOrder(new PerformanceProposal(25.9099f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-401"));
		p2Bot.insertInOrder(new PerformanceProposal(24.40802f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-415"));
		p2Bot.insertInOrder(new PerformanceProposal(23.22956f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-452"));
		p2Bot.insertInOrder(new PerformanceProposal(25.34497f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-456"));
		p2Bot.insertInOrder(new PerformanceProposal(26.0076f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-462"));
		p2Bot.insertInOrder(new PerformanceProposal(25.3459f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-505"));
		p2Bot.insertInOrder(new PerformanceProposal(22.37433f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-506"));
		p2Bot.insertInOrder(new PerformanceProposal(26.5158f, "stplus-mod-split(PaymentSystem)-wrapper(IBooking)-ps2-508"));
		p2Bot.insertInOrder(new PerformanceProposal(24.89035f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-119"));
		p2Bot.insertInOrder(new PerformanceProposal(22.41572f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-242"));
		p2Bot.insertInOrder(new PerformanceProposal(27.062600000000003f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-278"));
		p2Bot.insertInOrder(new PerformanceProposal(25.4423f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-344"));
		p2Bot.insertInOrder(new PerformanceProposal(26.54004f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-373"));
		p2Bot.insertInOrder(new PerformanceProposal(25.4423f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-407"));
		p2Bot.insertInOrder(new PerformanceProposal(27.482509999999998f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-408"));
		p2Bot.insertInOrder(new PerformanceProposal(22.26184f, "stplus-mod-split(PaymentSystem)-wrapper(IBusinessTrip)-ps2-439"));
