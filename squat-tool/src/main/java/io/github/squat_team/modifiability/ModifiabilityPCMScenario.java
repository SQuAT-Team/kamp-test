...
public class ModifiabilityPCMScenario extends PCMScenario {
	...
	// New components, interfaces, required and provided roles, operations,
	// datatypes, parameters, among others
	...
	// We should probably read the changes from a CSV file...it should not be
