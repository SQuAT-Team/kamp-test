 ...
 * simulation. The warm-up period will rather be underestimated.
 * <p>
...
public class CrossingMeanWarmUpFilter {
    ...
    /**
     * determines how often the mean have to be crossed until subsequent samples are considered to
     * be stationary
     */
