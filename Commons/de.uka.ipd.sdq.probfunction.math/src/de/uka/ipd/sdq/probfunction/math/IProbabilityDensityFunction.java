 ...
 * 
 * For more information see http://en.wikipedia.org/wiki/Probability_Density_Function <br>
 * 
 * @author ihssane, jens
 * 
 */
public interface IProbabilityDensityFunction extends IProbabilityFunction {
    ...
    /**
     * Returns the smallest values of the domain. At the moment this will be zero. However, future
     * implementations might allow arbitrary values here.
     * 
     ...
     * h(x) = f(x) + g(x) <br>
     * 
     * An addition can only be performed if both functions are in the same domain (frequency or
     * time). If not a FunctionsInDifferenDomainsException is thrown. <br>
     * 
     * @param pdf
     ...
     *             Thrown if one of the function is of an unknown type (not SamplePDf or BoxedPDF).
     * @throws IncompatibleUnitsException
     *             Thrown if both functions have units that do not match.
     */
    IProbabilityDensityFunction add(IProbabilityDensityFunction pdf) throws FunctionsInDifferenDomainsException,
     ...
     * h(x) = f(x) * g(x) <br>
     * 
     * A multiplication can only be performed if both functions are in the same domain (frequency or
     * time). If not a FunctionsInDifferenDomainsException is thrown.
     * 
     * @param pdf
     ...
     *             Thrown if both functions have units that do not match.
     */
    IProbabilityDensityFunction mult(IProbabilityDensityFunction pdf) throws FunctionsInDifferenDomainsException,
            UnknownPDFTypeException, IncompatibleUnitsException;
     ...
     * h(x) = f(x) - g(x) <br>
     * 
     * A substraction can only be performed if both functions are in the same domain (frequency or
     * time). If not a FunctionsInDifferenDomainsException is thrown.
     * 
     * @param pdf
     ...
     *             Thrown if both functions have units that do not match.
     */
    IProbabilityDensityFunction sub(IProbabilityDensityFunction pdf) throws FunctionsInDifferenDomainsException,
            UnknownPDFTypeException, IncompatibleUnitsException;
     ...
     * h(x) = f(x) / g(x) <br>
     * 
     * A division can only be performed if both functions are in the same domain (frequency or
     * time). If not a FunctionsInDifferenDomainsException is thrown.
     * 
     * @param pdf
     ...
     * @throws UnknownPDFTypeException
     */
    IProbabilityDensityFunction div(IProbabilityDensityFunction pdf) throws FunctionsInDifferenDomainsException,
            UnknownPDFTypeException, IncompatibleUnitsException;
    ...
    /**
     * Computes the fourier transform of the probability density function. Can only be applied if
     * 'isInTimeDomain()' is true, otherwise a FunctionNotInTimeDomain exception is thrown.
     * 
    ...
    /**
     * Computes the inverse fourier transform of the probability density function. Can only be
     * applied if 'isInFrequencyDomain()' is true, otherwise a FunctionNotInFrequencyDomainException
     * is thrown.
     * 
     ...
     * Note that the randomvariables have to be independent.
     * 
     * @param pdf
     *            PDF to compare to.
     * @return Probability that the two random variables characterised by the PDFs are equal.
    ...
    /**
     * Computes the probability that the random variable specified by this PDF is greater than the
     * random variable specified by pdf. Note that the randomvariables have to be independent.
     * 
     * @param pdf
     *            PDF to compare to.
    ...
    /**
     * Computes the probability that the random variable specified by this PDF is less than the
     * random variable specified by pdf. Note that the randomvariables have to be independent.
     * 
     * @param pdf
     *            PDF to compare to.
    ...
    /**
     * Stretches the domain values of the PDF. This is equivalent to the multiplication of the
     * specified random variable by the given scalar.
     * 
     * @param scalar
     * @return
     */
