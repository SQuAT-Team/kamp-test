...
/**
 * Tests the {@link MCRWarmUpFilter}. This test case is intended for manual testing only. For
 * evaluating the outcome the date series needs to be plotted (e.g. as time series) and compared
 * manually.
 * 
