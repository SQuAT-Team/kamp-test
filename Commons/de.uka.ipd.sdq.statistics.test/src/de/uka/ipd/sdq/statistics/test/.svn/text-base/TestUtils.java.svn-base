...
public class TestUtils {
    ...
    public static Collection<Measurement> loadMeasurements(IDAOFactory factory, String experimentName, int runId,
            int sensorId) {
    ...
    public static Collection<Measurement> loadMeasurements(IDAOFactory factory, int experimentId, int runId,
            int sensorId) {
        IExperimentDAO experimentDAO = factory.createExperimentDAO();
