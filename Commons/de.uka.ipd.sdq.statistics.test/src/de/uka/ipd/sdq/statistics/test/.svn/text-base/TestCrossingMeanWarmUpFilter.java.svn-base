...
/**
 * Tests the {@link CrossingMeanWarmUpFilter}. This test case is intended for manual testing only.
 * For evaluating the outcome the date series needs to be plotted (e.g. as time series) and compared
 * manually.
 * 
...
public class TestCrossingMeanWarmUpFilter extends TestCase {
    ...
    public void testWarmUpFilter() {
        ...
        if (dataStoreFolder.exists()) {
            ...
            Collection<Measurement> measurements = TestUtils.loadMeasurements(factory, 0, 0, 24);
