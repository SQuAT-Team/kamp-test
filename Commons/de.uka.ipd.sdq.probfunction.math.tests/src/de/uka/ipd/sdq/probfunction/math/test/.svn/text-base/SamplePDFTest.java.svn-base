...
public class SamplePDFTest {
    ...
    @Before
    public void setUp() {
        df1 = createSamplePDF(10, new Double[] {
                0.1, 0.2, 0.4, 0.3
        });
        df2 = createSamplePDF(10, new Double[] {
                0.0, 0.2, 0.1, 0.2, 0.3, 0.2
        });
        df3 = createSamplePDF(10, new Double[] {
                0.0, 0.2, 0.05, 0.15, 0.3, 0.2, 0.07, 0.03, 0.0
        });
    }
    ...
    public void equals() {
        ...
        ISamplePDF df1copy = createSamplePDF(10, new Double[] {
                0.1, 0.2, 0.4, 0.3
        });
        Assert.assertTrue(df1.equals(df1copy));

        ISamplePDF df1LongCopy = createSamplePDF(10, new Double[] {
                0.1, 0.2, 0.4, 0.3, 0.0
        });
        Assert.assertTrue(df1.equals(df1LongCopy));

        ISamplePDF df1LongWrongCopy = createSamplePDF(10, new Double[] {
                0.1, 0.2, 0.4, 0.3, 0.0, 0.01
        });
        Assert.assertFalse(df1.equals(df1LongWrongCopy));

        Assert.assertFalse(df2.equals(df1));
        ISamplePDF df1WrongCopy = createSamplePDF(10, new Double[] {
                0.2, 0.1, 0.4, 0.3
        });
    ...
    public void scale() {
        ...
        ISamplePDF spdf = createSamplePDF(10, new Double[] {
                0.01, 0.02, 0.04, 0.03
        });
    ...
    public void adjustDistance() throws NegativeDistanceException, FunctionNotInTimeDomainException {
        ...
        ISamplePDF expected = createSamplePDF(5.0, new Double[] {
                0.05, 0.1, 0.1, 0.15, 0.2, 0.175, 0.15, 0.075
        });
        Assert.assertEquals(expected, pdf);

        pdf = df1.getFunctionWithNewDistance(7.0);
        expected = createSamplePDF(7, new Double[] {
                0.07, 0.14, 0.19, 0.28, 0.215, 0.105
        });
        Assert.assertEquals(expected, pdf);

        pdf = df1.getFunctionWithNewDistance(15.0);
        expected = createSamplePDF(15, new Double[] {
                0.15, 0.45, 0.4
        });
        Assert.assertEquals(expected, pdf);

        pdf = df1.getFunctionWithNewDistance(13.0);
        expected = createSamplePDF(13, new Double[] {
                0.13, 0.35, 0.445, 0.075
        });
        Assert.assertEquals(expected, pdf);
    }
    ...
    public void add() throws FunctionsInDifferenDomainsException, UnknownPDFTypeException, IncompatibleUnitsException {
        ...
        sum = df1.add(df3);
        sumExpected = createSamplePDF(10, new Double[] {
                0.1, 0.4, 0.45, 0.45, 0.3, 0.2, 0.07, 0.03, 0.0
        });
        Assert.assertEquals(sumExpected, sum);

        ISamplePDF pdf = createSamplePDF(5, new Double[] {
                0.05, 0.05, 0.1, 0.1, 0.2, 0.2, 0.15, 0.15
        });
        sum = df1.add(pdf);
        sumExpected = createSamplePDF(5, new Double[] {
                0.1, 0.15, 0.2, 0.25, 0.4, 0.375, 0.3, 0.225
        });
        Assert.assertEquals(sumExpected, sum);
    }
    ...
    @Test
    public void checkConstraints() throws NegativeDistanceException, ProbabilitySumNotOneException,
    ...
    public void checkConstraints1() throws NegativeDistanceException, ProbabilitySumNotOneException,
            FunctionNotInTimeDomainException, UnitNotSetException, UnitNameNotSetException, InvalidSampleValueException {
        ISamplePDF s = createSamplePDF(-1.0, new Double[] {
                0.1, 0.4, 0.2, 0.3, 0.2
        });
        s.checkConstrains();
    }
    ...
    public void checkConstraints2() throws NegativeDistanceException, ProbabilitySumNotOneException,
            FunctionNotInTimeDomainException, UnitNotSetException, UnitNameNotSetException, InvalidSampleValueException {
        ISamplePDF s = createSamplePDF(1.0, new Double[] {
                0.1, 0.4, 0.2, 0.3, 0.2
        });
    ...
    public void checkConstraints3() throws NegativeDistanceException, ProbabilitySumNotOneException,
            FunctionNotInTimeDomainException, UnitNotSetException, UnitNameNotSetException, InvalidSampleValueException {
        ISamplePDF s = createSamplePDF(1.0, new Double[] {
                0.1, -0.4, 0.2, 1.1
        });
    ...
    public void checkConstraints4() throws NegativeDistanceException, ProbabilitySumNotOneException,
            FunctionNotInTimeDomainException, UnitNotSetException, UnitNameNotSetException, InvalidSampleValueException {
