...
public class SecurityUtil {
    ...
    /*
     * Algorithm: 1. Generate Secure random: Salt 2. Hashing password with Salt (salted hash):
     * SHA-512 3. Salt added to hash(the last 10 Bytes) 4. Password will be saved in DB as: Salted
     * hash + Salt
     */
