...
public class AudioFile implements Serializable {
    ...
    private static final long serialVersionUID = 5492067685932410676L;
    ...
    public AudioFile(final AudioFileInfo info, final byte[] bytes, final int length) {
        super();
        this.info = info;
        this.bytes = bytes;
        this.length = length;
