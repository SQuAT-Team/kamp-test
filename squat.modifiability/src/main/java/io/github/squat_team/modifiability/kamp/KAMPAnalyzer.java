...
public class KAMPAnalyzer {
	private EvaluationType evaluationType;
	private ModifiabilityPCMScenario scenario;
	protected ArchitectureVersion baseAV;
	protected ArchitectureVersion changedAV;

	public KAMPAnalyzer(ModifiabilityPCMScenario scenario, EvaluationType evaluationType) {
		if (scenario == null) {
			throw new IllegalArgumentException("scenario must not be null");
		}
		if (evaluationType == null) {
			throw new IllegalArgumentException("evaluation type must not be null");
		}
	...
	public PCMResult analyze(PCMArchitectureInstance currentArchitecture) {
		try {
			...
			if (evaluationType.equals(EvaluationType.ELEMENTS)) {
			...
			} else if (evaluationType.equals(EvaluationType.COMPLEXITY)) {
