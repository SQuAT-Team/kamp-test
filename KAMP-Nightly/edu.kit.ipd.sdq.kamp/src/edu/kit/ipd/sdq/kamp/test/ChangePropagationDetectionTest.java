...
public class ChangePropagationDetectionTest {
	...
	public void testDatatypeDependencyRetrieval() {
		...
		Map<OperationInterface, List<OperationSignature>> dependentInterfaces2 = ArchitectureModelLookup.lookUpInterfacesAndSignaturesWithParameterOfType(targetArchitectureVersion, datatype);
		...
		assertTrue("Dependent ClientInterface not retrieved properly", dependentInterfaces2.keySet().contains(clientInterface));
