 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.ipd.sdq.kamp.model.fieldofactivityannotations.impl.IntegrationTestCaseAggregationImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp.model.fieldofactivityannotations.impl.IntegrationTestCaseAggregationImpl#getProvidedrole <em>Providedrole</em>}</li>
 *   <li>{@link edu.kit.ipd.sdq.kamp.model.fieldofactivityannotations.impl.IntegrationTestCaseAggregationImpl#getAssemblyConnector <em>Assembly Connector</em>}</li>
 * </ul>
 *
 * @generated
 */
