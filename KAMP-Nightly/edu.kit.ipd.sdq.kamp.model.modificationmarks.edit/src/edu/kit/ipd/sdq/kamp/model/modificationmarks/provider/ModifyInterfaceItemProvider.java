...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp.model.modificationmarks.ModifyInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModifyInterfaceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModifyInterface_operationInterface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModifyInterface_operationInterface_feature", "_UI_ModifyInterface_type"),
				 modificationmarksPackage.Literals.MODIFY_INTERFACE__OPERATION_INTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(modificationmarksPackage.Literals.MODIFY_INTERFACE__SIGNATURE_MODIFICATIONS);
		}
	...
	public String getText(Object object) {
		String label = LabelCustomizing.customize((ModifyInterface)object);
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ModifyInterface.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(modificationmarksPackage.Literals.MODIFY_INTERFACE__SIGNATURE_MODIFICATIONS,
