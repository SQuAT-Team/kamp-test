 ...
 * <!-- end-user-doc -->
 * @see de.uka.ipd.sdq.fieldOfActivityAnnotations.util.FieldOfActivityAnnotationsResourceImpl
 * @generated
 */
public class FieldOfActivityAnnotationsResourceFactoryImpl extends ResourceFactoryImpl {
	...
	public Resource createResource(URI uri) {
		XMLResource result = new FieldOfActivityAnnotationsResourceImpl(uri);
		return result;
	}
