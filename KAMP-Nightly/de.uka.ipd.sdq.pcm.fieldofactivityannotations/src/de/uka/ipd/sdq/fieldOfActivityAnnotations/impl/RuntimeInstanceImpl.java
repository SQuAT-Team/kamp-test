 ...
 * </p>
 * <ul>
 *   <li>{@link de.uka.ipd.sdq.fieldOfActivityAnnotations.impl.RuntimeInstanceImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.uka.ipd.sdq.fieldOfActivityAnnotations.impl.RuntimeInstanceImpl#getComponent <em>Component</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RuntimeInstanceImpl extends IdentifierImpl implements RuntimeInstance {
	/**
	...
	public ImplementationComponentType getComponent() {
		if (component != null && ((EObject)component).eIsProxy()) {
			...
			if (component != oldComponent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FieldOfActivityAnnotationsPackage.RUNTIME_INSTANCE__COMPONENT, oldComponent, component));
			}
		}
		return component;
	}
	...
	public void setComponent(ImplementationComponentType newComponent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FieldOfActivityAnnotationsPackage.RUNTIME_INSTANCE__COMPONENT, oldComponent, component));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FieldOfActivityAnnotationsPackage.RUNTIME_INSTANCE__NAME:
				return getName();
			case FieldOfActivityAnnotationsPackage.RUNTIME_INSTANCE__COMPONENT:
