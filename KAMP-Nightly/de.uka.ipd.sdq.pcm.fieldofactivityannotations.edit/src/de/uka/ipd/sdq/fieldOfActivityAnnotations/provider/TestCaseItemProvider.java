...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.fieldOfActivityAnnotations.TestCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TestCaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FieldOfActivityAnnotationsPackage.Literals.TEST_CASE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addProvidedRolesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TestCase_providedRoles_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TestCase_providedRoles_feature", "_UI_TestCase_type"),
				 FieldOfActivityAnnotationsPackage.Literals.TEST_CASE__PROVIDED_ROLES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FieldOfActivityAnnotationsPackage.Literals.TEST_CASE__TEST_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FieldOfActivityAnnotationsPackage.Literals.TEST_CASE__TEST_TYPE,
				 TestType.UNIT_TEST));
	}
