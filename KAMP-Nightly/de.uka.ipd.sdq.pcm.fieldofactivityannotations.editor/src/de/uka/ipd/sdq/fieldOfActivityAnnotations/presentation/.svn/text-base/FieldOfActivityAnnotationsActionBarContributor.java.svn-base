/**
 */
package de.uka.ipd.sdq.fieldOfActivityAnnotations.presentation;
...
public class FieldOfActivityAnnotationsActionBarContributor
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(FieldOfActivityAnnotationsEditorPlugin.INSTANCE.getString("_UI_FieldOfActivityAnnotationsEditor_menu"), "de.uka.ipd.sdq.fieldOfActivityAnnotationsMenuID");
