...
/**
 * This is the item provider adapter for a {@link edu.kit.ipd.sdq.kamp.model.fieldofactivityannotations.AcceptanceTestCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AcceptanceTestCaseItemProvider
