		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Modification_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Modification_id_feature", "_UI_Modification_type"),
				 modificationmarksPackage.Literals.MODIFICATION__ID,
				 true,
				 false,
				 false,
	...
	protected void addToolderivedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Modification_toolderived_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Modification_toolderived_feature", "_UI_Modification_type"),
				 modificationmarksPackage.Literals.MODIFICATION__TOOLDERIVED,
				 true,
				 false,
				 false,
	...
	protected void addUserDecisionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Modification_userDecision_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Modification_userDecision_feature", "_UI_Modification_type"),
				 modificationmarksPackage.Literals.MODIFICATION__USER_DECISION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
