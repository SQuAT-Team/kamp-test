...
/**
 * This is the item provider adapter for a {@link de.uka.ipd.sdq.fieldOfActivityAnnotations.BuildConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildConfigurationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BuildConfiguration_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BuildConfiguration_name_feature", "_UI_BuildConfiguration_type"),
				 FieldOfActivityAnnotationsPackage.Literals.BUILD_CONFIGURATION__NAME,
				 true,
				 false,
				 false,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BuildConfiguration_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BuildConfiguration_components_feature", "_UI_BuildConfiguration_type"),
				 FieldOfActivityAnnotationsPackage.Literals.BUILD_CONFIGURATION__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((BuildConfiguration)object).getName();
