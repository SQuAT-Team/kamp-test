...
public class modificationmarksPackageImpl extends EPackageImpl implements modificationmarksPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getModification_UserDecision(), this.getAcceptanceAndConfirmationState(), "userDecision", "0", 1, 1, Modification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
